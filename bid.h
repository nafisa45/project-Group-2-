...
int callnumbercopy(SDL_Renderer* rend,imginfo n0,imginfo n1,imginfo n2,imginfo n3,imginfo n4,imginfo n5,imginfo n6,imginfo n7,imginfo n8,imginfo n9,imginfo n10,imginfo n11,imginfo n12,imginfo n13,imginfo n14,imginfo n15,imginfo n16,imginfo n17,imginfo n18,imginfo n19,imginfo n20,imginfo n21,imginfo n22,imginfo n23,imginfo n24,imginfo n25,int* score)
{
    for(int i=0; i<4; i++)
    {
        ...
        if(x==0)
        {
            scorecopy(rend,n0.tex,n0.dest,i );
        }

        else if(x==1)
        {
            scorecopy(rend,n1.tex,n1.dest,i );
        }
        else if(x==2)
        {
            scorecopy(rend,n2.tex,n2.dest,i );
        }
        else if(x==3)
        {
            scorecopy(rend,n3.tex,n3.dest,i );
        }
        else if(x==4)
        {
            scorecopy(rend,n4.tex,n4.dest,i );
        }
        else if(x==5)
        {
            scorecopy(rend,n5.tex,n5.dest,i );
        }
        else if(x==6)
        {
            scorecopy(rend,n6.tex,n6.dest,i );
        }
        else if(x==7)
        {
            scorecopy(rend,n7.tex,n7.dest,i );
        }
        else if(x==8)
        {
            scorecopy(rend,n8.tex,n8.dest,i );
        }
        else if(x==9)
        {
            scorecopy(rend,n9.tex,n9.dest,i );
        }
        else if(x==10)
        {
            scorecopy(rend,n10.tex,n10.dest,i );
        }
    }
    return 0;
